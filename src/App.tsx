      ...
      rightPanel={
        !liminalOpen && activeView !== "settings" ? (
          <RightDrawer
            ...
            handleStopAgentStream={agent.handleStopAgentStream}
            handleApproveAgentTool={agent.handleApproveAgentTool}
            handleRejectAgentTool={agent.handleRejectAgentTool}
            pendingApproval={agent.pendingApproval}
            isAgentStreaming={agent.isAgentStreaming}
            contextItems={agent.contextItems}
            addContextItem={agent.addContextItem}
            removeContextItem={agent.removeContextItem}
            notes={notes}
            rules={rules}
